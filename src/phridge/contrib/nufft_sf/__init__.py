...
from phridge.contrib.nufft_sf.op import BIND_OP, CALC_OP, GRAD_OP, register_ops
from phridge.contrib.nufft_sf.options import NufftEngineOptions

__all__ = ["BIND_OP", "CALC_OP", "GRAD_OP", "NufftEngineOptions", "register"]
...
# So ``--preload phridge.contrib.nufft_sf`` registers without a separate call.
register()
