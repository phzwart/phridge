...
def main(args: list[str] | None = None) -> int:
    ...
    for xs in opts.xray_scales:
        ...
        for i_rep, pdb_path in enumerate(pert_files):
            ...
            rec: Dict[str, Any] = {
                ...
                "r_int_free_start": float(summ0["r_int_free"]),
                "r_int_free_final": float(summ_final["r_int_free"]),
    ...
    for xs in opts.xray_scales:
        ...
        agg[xs] = {
            ...
            "r_int_free_final_mean": float(np.mean([g["r_int_free_final"] for g in group])),
